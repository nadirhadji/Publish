...
class __TwigTemplate_13b77975c1be686d2c45899c2439b2b0d1ad1ce451a6b0592a0b7834a4d410df extends Twig_Template
{
    private $source;
...
$this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "year", []), 'widget'), "{{ month }}" =>             // line 75
$this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "month", []), 'widget'), "{{ day }}" =>             // line 76
...
($context["choice_translation_domain"] ?? null)]);
    ...
    {
        return new Twig_Source("", "bootstrap_base_layout.html.twig", "/Applications/MAMP/htdocs/2018-l3ac1/branches/Publish/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form/bootstrap_base_layout.html.twig");
    }
}
