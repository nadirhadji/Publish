...
class __TwigTemplate_20b97be36d8fdf6aadd6377f49c668f1fa46375ce95b92e40008f071767cad53 extends Twig_Template
{
    private $source;
...
<div class=\"fos_user_user_show\">
    <p>";
        ...
        echo ": ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new Twig_Error_Runtime('Variable "user" does not exist.', 4, $this->source); })()), "username", []), "html", null, true);
        echo "</p>
    <p>";
        // line 5
        ...
        echo ": ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new Twig_Error_Runtime('Variable "user" does not exist.', 5, $this->source); })()), "email", []), "html", null, true);
        echo "</p>
</div>
";
...
", "@FOSUser/Profile/show_content.html.twig", "/Applications/MAMP/htdocs/2018-l3ac1/branches/Publish/vendor/friendsofsymfony/user-bundle/Resources/views/Profile/show_content.html.twig");
    }
}
