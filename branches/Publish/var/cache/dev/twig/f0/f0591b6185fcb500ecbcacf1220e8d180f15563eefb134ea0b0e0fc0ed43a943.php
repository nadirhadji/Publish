...
class __TwigTemplate_edec38937142b18c24a2641b26779494ef8d4f76fd1cc41970c44f8b7ab8e966 extends Twig_Template
{
    private $source;
...
";
    ...
    public function block_subject($context, array $blocks = [])
    {
        ...
        // line 4
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("resetting.email.subject", ["%username%" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new Twig_Error_Runtime('Variable "user" does not exist.', 4, $this->source); })()), "username", [])], "FOSUserBundle");
