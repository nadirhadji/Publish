...
$catalogue = new MessageCatalogue('bg', array (
  ...
  array (
    ...
    'This value should be a multiple of {{ compared_value }}.' => 'Тази стойност трябва да бъде кратно число на {{ compared_value }}.',
    'This Business Identifier Code (BIC) is not associated with IBAN {{ iban }}.' => 'Този бизнес идентификационен код (BIC) не е свързана с IBAN {{ iban }}.',
    'This value should be valid JSON.' => 'Тази стойност трябва да е валидна JSON.',
