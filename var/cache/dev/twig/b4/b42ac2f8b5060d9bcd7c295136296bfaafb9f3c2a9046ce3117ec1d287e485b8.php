...
class __TwigTemplate_05f216b614eb759df0dbc1b6ce6443e8910f5c53e9511cde6e2abf8d521d958a extends Twig_Template
{
    private $source;
...
";
    ...
    public function block_body_text($context, array $blocks = [])
    {
        ...
        // line 9
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("registration.email.message", ["%username%" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new Twig_Error_Runtime('Variable "user" does not exist.', 9, $this->source); })()), "username", []), "%confirmationUrl%" => (isset($context["confirmationUrl"]) || array_key_exists("confirmationUrl", $context) ? $context["confirmationUrl"] : (function () { throw new Twig_Error_Runtime('Variable "confirmationUrl" does not exist.', 9, $this->source); })())], "FOSUserBundle");
        echo "
";
    ...
    {
        return array (  88 => 12,  76 => 9,  67 => 7,  55 => 4,  46 => 2,  36 => 12,  34 => 7,  32 => 2,);
    }
